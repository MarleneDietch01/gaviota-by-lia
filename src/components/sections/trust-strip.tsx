  ...
  return (
    <Section tone="powder" padding="none" className="py-6 sm:py-7" labelledBy="trust-strip-heading">
      <Container>
        ...
        <ul className="grid gap-5 sm:grid-cols-3 sm:gap-0 sm:divide-x sm:divide-gold-ink/20">
          {points.map((point) => {
            ...
            return (
              ...
              >
                <span className="grid size-10 shrink-0 place-items-center rounded-full border border-gold-ink/20">
                  <Icon className="size-4 text-gold-ink" strokeWidth={1.5} aria-hidden="true" />
                </span>
                <div>
