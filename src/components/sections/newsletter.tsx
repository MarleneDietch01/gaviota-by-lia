    ...
    <Section tone="ivory" padding="compact" labelledBy="newsletter-title">
      <Container size="narrow">
        <Reveal className="text-center">
          {c.eyebrow ? <p className="eyebrow mb-3 text-caramel">{c.eyebrow}</p> : null}
          ...
          <a
            ...
            className="premium-button mt-9 inline-flex min-h-12 items-center overflow-hidden rounded-xs bg-caramel px-7 text-sm font-semibold tracking-[0.02em] text-white-warm transition-[background-color,box-shadow,transform] duration-300 hover:bg-caramel-deep"
          >
