...
export function WhatsAppButton({ locale }: { locale: Locale }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-30 inline-flex min-h-12 items-center justify-center gap-2 rounded-pill bg-gold-ink px-3.5 text-sm font-semibold text-white-warm shadow-lift transition-[background-color,transform] duration-300 ease-soft hover:bg-plum motion-safe:hover:-translate-y-0.5 sm:right-6 sm:px-5 lg:bottom-6"
    >
