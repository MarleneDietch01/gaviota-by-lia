...
export function WhatsAppButton({ locale }: { locale: Locale }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-5 z-30 inline-flex min-h-12 items-center justify-center gap-2 rounded-pill border border-gold-deep/25 bg-champagne px-3.5 text-sm font-semibold text-ink shadow-lift transition-[background-color,transform] duration-300 ease-soft hover:bg-gold motion-safe:hover:-translate-y-0.5 sm:right-6 sm:px-5 lg:bottom-6"
    >
