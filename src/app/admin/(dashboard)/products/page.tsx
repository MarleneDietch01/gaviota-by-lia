  ...
  return (
    <div>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Link href="/admin/products/new" className="min-h-10 rounded-xs bg-champagne px-5 py-2.5 text-sm font-semibold text-ink hover:bg-gold">
          Crear producto
        </Link>
                    ...
                    <tr key={product.id} className="border-b border-line last:border-0">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="mb-2 flex justify-end gap-2">
                          <Link href={`/admin/products/${product.id}`} className="min-h-9 rounded-xs bg-champagne px-3 py-2 text-xs font-semibold text-ink hover:bg-gold">Editar</Link>
