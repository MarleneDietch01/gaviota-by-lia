      ...
      <Section tone="ivory">
        <Container>
          ...
          <header className="mb-10 max-w-2xl sm:mb-14">
            <p className="eyebrow mb-3 text-gold-deep">{localizedCopy(page.eyebrow, lang)}</p>
      ...
      <Section tone="ivory">
        <Container>
          <header className="mx-auto mb-10 max-w-2xl text-center sm:mb-14">
            <p className="eyebrow text-gold-deep">{localizedCopy(page.eyebrow, lang)}</p>
        ...
        <Container>
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16 xl:gap-20">
            ...
            <Reveal delay={80} className="max-w-[34rem]">
              <p className="eyebrow mb-4 text-gold-deep">{localizedCopy(page.eyebrow, lang)}</p>
              <h1 className="text-h1">{localizedCopy(page.title, lang)}</h1>
              ...
              <ul className="space-y-6">
                {documented.map((product) => (
                  ...
                  >
                    ...
                    <h3 className="eyebrow mt-6 text-gold-deep">
                    ...
                    {product.usageInstructions ? (
                      <div className="mt-5">
                        <h3 className="eyebrow text-gold-deep">{pick(lang, 'How to use', 'Modo de uso')}</h3>
                    ...
                    {product.precautions ? (
                      <div className="mt-5">
                        <h3 className="eyebrow text-gold-deep">{pick(lang, 'Precautions', 'Precauciones')}</h3>
                        <p className="mt-2 text-body-sm leading-relaxed text-body">
                          {product.precautions}
                        </p>
                      </div>
