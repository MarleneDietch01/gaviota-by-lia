...
export const ROUTE_PAGES: Readonly<Record<string, RoutePage>> = {
  ...
  faq: {
    eyebrow: c('Customer care', 'Atención al cliente'),
    title: c('Body care orders: shipping, returns & product questions', 'Tu compra: envíos, devoluciones y cuidado corporal'),
    body: [c('Find answers about shopping Gaviota by Lia in the United States, order tracking, returns and choosing body care for your routine.', 'Resuelve tus dudas sobre comprar Gaviota by Lia en Estados Unidos, seguir tu pedido, solicitar una devolución y elegir tu cuidado corporal.')],
    sections: [
      {
        heading: c('Do you ship within the United States?', '¿Hacen envíos dentro de Estados Unidos?'),
        body: [c('Yes. We currently ship within the United States only, using USPS Priority Mail. See our shipping policy for rates, free-shipping eligibility, processing and estimated delivery times.', 'Sí. Por ahora enviamos únicamente dentro de Estados Unidos, mediante USPS Priority Mail. Consulta nuestra política de envíos para conocer la tarifa, las condiciones del envío gratis, el procesamiento y los plazos estimados.')],
      },
      {
        heading: c('How do I track my order?', '¿Cómo puedo seguir mi pedido?'),
        body: [c('Once your order ships, we email you the tracking number. If you need help finding it, contact us with your order number.', 'Cuando se envíe tu pedido, te mandamos el número de seguimiento por correo electrónico. Si necesitas ayuda para encontrarlo, escríbenos con tu número de pedido.')],
      },
      {
        heading: c('What currency will I pay in?', '¿En qué moneda se cobra?'),
        body: [c('Prices are in U.S. dollars (USD). Payments are processed through Stripe, and you can review your total before confirming the purchase.', 'Los precios están en dólares estadounidenses (USD). Los pagos se procesan a través de Stripe y puedes revisar el total antes de confirmar la compra.')],
      },
      {
        heading: c('Can I return a product?', '¿Puedo devolver un producto?'),
        body: [c('You have 30 calendar days from delivery to request a return of an unopened product with its seal intact and original packaging. Contact us before sending anything back. See the return policy for shipping costs and damaged or incorrect items.', 'Tienes 30 días naturales desde la entrega para solicitar la devolución de un producto sin abrir, con el precinto intacto y su empaque original. Escríbenos antes de enviarlo. Consulta la política de devoluciones para conocer los costos de envío y qué hacer si recibiste un artículo dañado o equivocado.')],
      },
      {
        heading: c('Where can I find ingredients and directions?', '¿Dónde consulto los ingredientes y el modo de uso?'),
        body: [c('Product pages include the available ingredient lists, directions and precautions. Browse body oils, hydrating cream, coconut scrub and post-hair-removal serum, then read the details of the product you are considering. You can also ask us a product question before ordering.', 'Las fichas de producto incluyen los ingredientes, instrucciones y precauciones disponibles. Explora los aceites, la crema hidratante, el exfoliante de coco y el sérum post-depilación, y consulta la ficha del producto que te interesa. También puedes escribirnos antes de comprar.')],
      },
    ],
    links: [
      { href: '/shop', label: c('Shop body care', 'Comprar cuidado corporal') },
      { href: '/shipping-policy', label: c('Shipping policy', 'Política de envíos') },
      { href: '/refund-policy', label: c('Return policy', 'Política de devoluciones') },
      { href: '/contact', label: c('Contact us', 'Contáctanos') },
    ],
  },
  ...
  'track-order': { eyebrow: c('Orders', 'Pedidos'), title: c('Track your order', 'Seguir mi pedido'), body: [c('When your order ships, we email you a tracking link. Check your inbox and spam folder. If you cannot find it, contact us with your order number and the email used at checkout.', 'Cuando enviamos tu pedido, recibes un enlace de seguimiento por correo. Revisa tu bandeja de entrada y correo no deseado. Si no lo encuentras, escríbenos con tu número de pedido y el correo utilizado en la compra.')], links: [{ href: '/contact', label: c('Get help', 'Obtener ayuda') }] },
